...
fOpt = fitoptions('Method','NonlinearLeastSquares',...
                'Lower',[2.5 0 0],...
                'Upper',[4.2 0.06 5],...
                'StartPoint',[0.7988 0.0027 0.2222]); %[0.7988 0.0027 0.5212 0.7114 0.2222]
fTyp = fittype('a0-a1*exp(-b1*x)','options',fOpt);
...
legend({"Measured","Model"},"interpreter","latex","fontsize",14,...
       "location","northwest")
%% Saving data
save("DS_002_RCpar_firstOrder","pR0","pVoc","R0_c","R1_c","C1_c")